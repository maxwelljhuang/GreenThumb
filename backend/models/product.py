...
class ProductIngestion(BaseModel):
    ...
    def calculate_quality_score(self) -> float:
        ...
        image_count = sum(1 for img in [
            self.merchant_image_url, self.aw_image_url, self.large_image,
            self.alternate_image, self.alternate_image_two
        ] if img)
        if image_count >= 2:
    ...
    def get_alternate_images(self) -> List[str]:
        ...
        images = []
        for field in ['alternate_image', 'alternate_image_two', 
...
class ProductCanonical(BaseModel):
    ...
    def from_ingestion(cls, ingestion: ProductIngestion) -> 'ProductCanonical':
        ...
        return cls(
            ...
            merchant_image_url=str(ingestion.merchant_image_url) if ingestion.merchant_image_url else None,
